...
<div class="container-fluid py-4">
    ...
    <a class="navbar-brand" class = "btn btn-info">Dashboard</a>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header text-center" style="size: 22px;">Self Certification Reports</div>
                    <div class="card-body">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Absence Due to Accident</th>
                                        <th>Consulted Medical Practitioner</th>
                                        <th>Medical Advice</th>
                                        <th>Declaration</th>
                                        <th>Declaration Name</th>
                                        <th>Declaration Last Name</th>
                                ...
                                <tbody>
                                    @foreach ($reports as $report)
                                        <tr>
                                            ...
                                            <td>{{ $report->service_department }}</td>
                                            <td>{{ $report->absence_date }}</td>
                                            <td>{{ $report->reason_of_absence }}</td>
                                            <td>{{ $report->absence_due_to_accident }}</td>
                                            <td>{{ $report->consulted_medical_practitioner }}</td>
                                            <td>{{ $report->medical_advice }}</td>
                                            <td>{{ $report->declaration }}</td>
                                            <td>{{ $report->declaration_name }}</td>
                                            <td>{{ $report->declaration_last_name }}</td>
