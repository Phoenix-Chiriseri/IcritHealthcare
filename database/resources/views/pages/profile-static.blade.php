            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="/img/icritLogo.jpg" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="assessment_date" name="assessment_date" value = "{{$user->name}}" required>
            </div>

            <div class="form-group">
                <label for="service_user_name">Service User Name</label>
                <input type="text" class="form-control" id="service_user_name" name="service_user_name" required>
            </div>
